...
class TestUsers:
    ...
    async def test_get_user(
        ...
        response = await class_users_client.get_user_api(
    ...
    async def test_update_user(
        ...
        response = await class_users_client.update_user_api(
    ...
    async def test_delete_user(
        ...
        delete_question_response = await class_users_client.delete_user_api(
            function_user.id
        )
        get_question_response = await class_users_client.get_user_api(
            function_user.id
        )
